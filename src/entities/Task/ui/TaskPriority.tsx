        ...
        <div className="relative">
          <div
            className={classNames(
              "flex cursor-pointer flex-row items-center px-2 py-1 " +
          ...
          >
            <div className={"mr-2 text-lg " + `${Colors[color]}`}>
              <FaFlag />
            </div>
            <div>
            ...
            {/* <div className="ml-2 cursor-pointer text-sm opacity-50 hover:opacity-100"><MdEdit/></div> */}
          </div>

          {activeEditPriority && (
            <div
              className={
                "absolute w-full cursor-pointer rounded-b-lg pb-2 pt-1 text-center text-sm " +
                `${backgroundColors[backgroundColor]}`
              }
            >
              {priorities.map((el, key) => (
                <div key={key} data-id={el.idPriority} onClick={editPriority}>
                  {el.namePriority}
                </div>
              ))}
            </div>
